...
// Admin Customizations (moved from functions.php)
require_once get_template_directory() . '/inc/admin-customizations.php';

// Product filtering AJAX (keeping existing include)
...
function add_resource_hints() {
    ...
    // Preconnect to unpkg.com for web-vitals library
...
?>
    <script type="module">
        ...
        onLCP((({ value, id, attribution }) => send('LCP', value, id, attribution)));
        onINP((({ value, id, attribution }) => send('INP', value, id, attribution)));
        onCLS((({ value, id, attribution }) => send('CLS', value, id, attribution)));
    </script>
    <?php
}
...
/**
 * Enhanced image function with performance attributes
 */
...
function insert_default_report_terms()
{
    ...
    $default_categories = array(
        ...
        'Financial Statements', 'Corporate Governance', 'Sustainability Reports',
        'Regulatory Filings', 'Press Releases', 'Notices & Disclosures', 'Policies & Guidelines'
    );
