...
/**
 * =============================================================================
 * GLOBAL FEATURES BLOCK LAYOUT 2
 * =============================================================================
 *
 * ACF Fields:
...
$features_items = get_sub_field('features_items');
$cta           = get_sub_field('cta');
?>

<?php if (($title || $features_items) && !$hide_block): ?>
    <section class="home-features-block fade-in">
        <div class="container-fluid relative">
            ...
            <div class="flex lg:flex-row flex-col gap-3 lg:gap-24">
                ...
                <?php if ($features_items && is_array($features_items) && count($features_items) > 0): ?>
                    <?php $delay = 0; // initialize delay 
                    ?>
                    <div class="mt-4 md:mt-0 w-full lg:w-7/12">
                        <div class="grid grid-cols-2 gap-4 sm:gap-8 md:gap-10 fade-up-stagger-wrap">
                            ...
                            ?>
                                <div class="feature-item  md:text-left text-center flex flex-col md:items-start items-center fade-up-stagger" data-delay="<?php echo number_format($delay, 1); ?>">

                                    <!-- Icon -->
                                    <?php if ($icon && is_array($icon) && !empty($icon['url'])): ?>
                                        <div class="feature-icon">
                                            <img class="w-[56px] h-[56px]" src="<?= esc_url($icon['url']); ?>"
                                    ...
                                    <div class="feature-content">
                                        <?php if ($item_title): ?>
                                            <div class="h3  my-1 md:my-2 !font-semibold !text-grey-1"><?= esc_html($item_title); ?></div>
                                        <?php endif; ?>
                                        <?php if ($item_content): ?>
            ...
            <div class="lg:block hidden absolute right-[-109px] bottom-[-150px] -z-1 pointer-none " data-speed="1.25">
                <img class="" src="<?= get_stylesheet_directory_uri(); ?>/assets/images/research/shape-3.png" alt="">
            </div>
