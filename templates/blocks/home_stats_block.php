  ...
  <section class="stats-block relative fade-in overflow-hidden"
    ...
    <div class="container-fluid relative">
      ...
      <?php if ($stats_items && count($stats_items) > 0): ?>
        <div class="stats-grid-items w-full lg:w-7/12 mx-auto py-6 md:py-12
            grid grid-cols-2 md:grid-cols-2 lg:grid-cols-<?php echo min(5, count($stats_items)); ?> gap-4 lg:gap-12">
      ...
      <!-- Decorative Shapes -->
      <div class="floating-item-left absolute left-0 bottom-0 -z-1 pointer-none w-[87px] lg:w-fit" data-speed="1.25">
        <img src="<?= get_stylesheet_directory_uri(); ?>/assets/images/home/shapes/shape-1.webp" alt="">
      </div>

      <div class="floating-item-right absolute right-[-45px] top-0 -z-1" data-speed="1.25">
